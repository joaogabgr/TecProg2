...
import AddClientesDependentes from './components/clientes/addClientes/addClientesDependentes';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path='/addClientesDependentes' element={<AddClientesDependentes />} />
        <Route path='/readClientes' element={<ReadClientes />} />
        <Route path='/editClientes' element={<EditClientes />} />
